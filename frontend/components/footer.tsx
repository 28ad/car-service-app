...
export default function FooterSection() {
    return (
        <footer className="py-16 md:py-32 bg-base-black">
            <div className="mx-auto max-w-5xl px-6">
                <Link
                    href="/"
                    aria-label="go home"
                    className="mx-auto block size-fit text-white text-3xl font-extrabold">
                    Logo
                </Link>
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} Alessio Dita</span>
            </div>
        </footer>
    )
}
